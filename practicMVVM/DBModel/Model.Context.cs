...
namespace practicMVVM.DBModel
{
    ...
    public partial class KingITEntities : DbContext
    {
        ...
        public virtual DbSet<statusRental> statusRental { get; set; }
        public virtual DbSet<statusSM> statusSM { get; set; }
        public virtual DbSet<sysdiagrams> sysdiagrams { get; set; }
        public virtual DbSet<tenats> tenats { get; set; }
        public virtual DbSet<Готовая_аренда> Готовая_аренда { get; set; }
        public virtual DbSet<Готовое_ТЦ> Готовое_ТЦ { get; set; }
        public virtual DbSet<Готовые_павильоны> Готовые_павильоны { get; set; }
    
        public virtual int rental1(string id_pavilion, Nullable<int> id_shopping_center, Nullable<int> status)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("rental1", id_pavilionParameter, id_shopping_centerParameter, statusParameter);
        }
        ...
        public virtual int updateRentalPavilion(string id_pavilion, Nullable<int> id_shopping_center, Nullable<int> status)
        {
            var id_pavilionParameter = id_pavilion != null ?
                new ObjectParameter("id_pavilion", id_pavilion) :
                new ObjectParameter("id_pavilion", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("updateRentalPavilion", id_pavilionParameter, id_shopping_centerParameter, statusParameter);
        }
    }
}
